--Ejercicio 1: Concatenar fistName and LasName en una sola columna y mostrar su tama�o.
...
--Ejercicio 3: Mostrar el nombre de la tienda y su ciudad, ordenados alfab�ticamente por ciudad.
...
--Ejercicio 7: Obtener los 5 productos m�s caros en la tienda.
SELECT TOP(5) * FROM Product
ORDER BY price DESC;

--Ejercicio 8: Obtener los �ltimos 10 clientes registrados seg�n su customerId, ordenados de m�s reciente a m�s antiguo.
SELECT TOP(10) * FROM Customer
ORDER BY customerId DESC;

--Ejercicio 9: Encontrar los correos electr�nicos gmail en la tabla Customer.
SELECT * FROM Customer
...
--Ejercicio 14: Mostrar cu�ntos productos hay en cada categor�a.
...
--Ejercicio 15: Mostrar cu�ntos pedidos ha realizado cada cliente, ordenados de mayor a menor.
